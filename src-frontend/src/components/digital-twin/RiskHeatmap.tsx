...
export const RiskHeatmap = ({ predictions }: any) => {
  ...
  return (
    <div className="space-y-3 max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
      ...
      {sorted.map((p: any) => (
        <div
          key={p.asset_id}
          className="p-3 bg-slate-50 dark:bg-[#161B22] border border-slate-100 dark:border-[#2A313C] rounded-lg flex items-center justify-between transition-colors hover:bg-slate-100 dark:hover:bg-[#1c222b]"
        >
